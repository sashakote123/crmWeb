...
const selectArray = [
  { status: 'Черновик', value: 0 },
  { status: 'В очереди', value: 1 },
  { status: 'В процессе', value: 2 },
  { status: 'Тестирование', value: 3 },
  { status: 'Готово', value: 4 },
  { status: 'Идея', value: 5 },
];

const CreateTaskForm: React.FC<Props> = ({ isOpen, setIsOpen }) => {
      ...
      <Fade in={true}>
        ...
        >
          ...
          <Grid container spacing={5} mb={9} maxWidth={435}>
            <Box width="100%">
              <StyledTypography>Название задачи</StyledTypography>
              <TextField
                {...register('name')}
                sx={{
                  '& .MuiInputBase-root': {
            ...
            <Box width="100%">
              <StyledTypography>Описание задачи</StyledTypography>
              <TextField
                {...register('desc')}
            ...
            <Box width="100%">
              <StyledTypography>Куратор</StyledTypography>
              <TextField
            ...
            <Box width="100%">
              <StyledTypography>Исполнитель</StyledTypography>
              <TextField
                {...register('invitedMembers')}
                sx={{
                  '& .MuiInputBase-root': {
